    ...
    vals_hr_salary_ruels = [
        {
            ...
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','HJ')],limit=1).id,
        ...
        },
        {
            ...
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','BASIC')],limit=1).id,
            'condition_select': 'none',
            'quantity': '173.33 / contract.base_mois',
            'amount_select':'code',
...
result = contract.wage - conge''',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','COEFF')],limit=1).id,
            'condition_select': 'none',
            'amount_select':'code',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','COT')],limit=1).id,
            'condition_select': 'python',
...
''',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','INTERM')],limit=1).id,
            'condition_select': 'none',
            'amount_select':'code',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','IMP15')],limit=1).id,
            'condition_select': 'python',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','IMP')],limit=1).id,
            'condition_select': 'python',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','ALW')],limit=1).id,
            'condition_select': 'python',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','DED')],limit=1).id,
            'condition_select': 'none',
            'amount_select':'percentage',
...
if  contract.base_mois  != worked_days.WORK100.number_of_days and worked_days.WORK100.number_of_days != 0 :
    salaire_mensuel = salaire_mensuel * contract.base_mois / (worked_days.WORK100.number_of_days + conge_day)
...
result = -(categories.BASIC + categories.ALW)''',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','GROSS')],limit=1).id,
            'condition_select': 'none',
            'amount_select':'percentage',
            'amount_percentage_base': 'categories.BASIC + categories.ALW',
            'quantity': '1',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','NET')],limit=1).id,
            'condition_select': 'none',
            'amount_select':'percentage',
        ...
        },
        {
            ...
            'active': True,
            'appears_on_payslip': True,
            'category_id': instance.env['hr.salary.rule.category'].search([('code','=','IMP10')],limit=1).id,
            'condition_select': 'python',
